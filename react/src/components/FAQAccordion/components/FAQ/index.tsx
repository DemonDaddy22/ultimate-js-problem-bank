import styles from '@/styles/FAQAccordion/faq.module.css';
...
const FAQ: React.FC<FAQProps> = ({ id, question, answer, isOpen, selectFaq }) => {
  return (
    <div className={styles.faq}>
      <button
        id={id.toString()}
        className={styles.question}
        onClick={() => selectFaq(id)}
      ...
      <p
        className={isOpen ? styles.answer : styles.hideAnswer}
        role='region'
